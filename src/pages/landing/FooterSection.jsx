...
import { Mail, Phone, MapPin, X as CloseIcon } from "lucide-react";
...
export default function FooterSection() {
  ...
  const socialLinks = [
    {
      icon: FaLinkedin,
      href: "https://www.linkedin.com/in/surajpal-singh-shekhawat-542215140/",
      label: "LinkedIn",
    },
    {
      icon: FaGithub,
      href: "https://github.com/ss-shekhawat",
      label: "Github",
    },
    {
      icon: FaWhatsapp,
      href: "https://wa.me/919829430727",
      label: "WhatsApp",
      isReactIcon: true,
    },
  ];
