...
const AssessmentIntroPage = () => {
  ...
  const { data: assessmentStatus } = useFetchAssessmentStatusQuery();
  ...
  const handleProceed = () => {
    ...
    let nextStep = "";
    switch (true) {
      case cTestCompleted !== true:
        nextStep = "personality";
        break;
      case iTestCompleted !== true:
        nextStep = "interest";
        break;
      default:
        nextStep = "aptitude";
    ...
    switch (nextStep) {
      case "personality":
        navigate("/student/test-instruction");
        break;
      case "interest":
        navigate("/student/assessment-instruction", {
          state: { testType: "interest-test" },
        });
        break;
      case "aptitude":
        navigate("/student/assessment-instruction", {
          state: { testType: "aptitude-test" },
        });
        break;
      default:
        break;
